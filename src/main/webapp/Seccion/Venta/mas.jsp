...
<html lang="es">
    ...
    <body onload="cargarArticulosVenta(<%=request.getParameter("codigo")%>)">
        <!-- Incluye la barra de navegacion que se encuentra en navegador.jsp -->
        <jsp:include page="../navegador.jsp" />
        <!-- Contenido principal contiene el formulario -->
        <section>
            <div>
                <h1 class="centrar-texto">Informacion de la venta</h1>
            </div>
            <br>
            <br>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input readOnly value="<%=request.getParameter("sucursal")%>" required  type="text" class="form-control ">
                    </div>
                    ...
                    <div class="col-md-3">
                        <input readOnly value="<%=request.getParameter("cliente")%>" required type="text" class="form-control ">
                    </div>
                    <div class="col-md-1"></div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input readOnly value="<%=request.getParameter("cajero")%>" required  type="text" class="form-control ">
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-1">
                        <p>Vendedor:</p>
                    ...
                    <div class="col-md-3">
                        <input readOnly value="<%=request.getParameter("vendedor")%>" required type="text" class="form-control ">
                    </div>
                    <div class="col-md-1"></div>
                </div>
                <br><div class="row">
